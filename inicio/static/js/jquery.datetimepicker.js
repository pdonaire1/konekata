	...
	$.fn.datetimepicker = function( opt ) {
		var KEY0 = 48,
			...
			createDateTimePicker = function( input ) {
				...
				datetimepicker
					.on('open.xdsoft', function() { /*alert('o');*/
					    //minDate: $( "#inicio" ).val();$("#fin").datepicker("option","minDate", $( "#inicio" ).val());
						var onShow = true;
					...
					.on('close.xdsoft', function( event ) {
						//$("#fin").datepicker("option","minDate", minDate)
						var onClose = true;
...
$('#id_fecha_solicitud').datetimepicker({
	dayOfWeekStart : 1,
	lang:'es',
	formatDate:'Y-m-d',
	minTime:'8:00',
...
$(".fecha_inicio").datepicker({
        dateFormat: 'dd/mm/yy',
        yearRange: '<%=(System.DateTime.Now.Year + 1).ToString()%>:<%=System.DateTime.Now.Year.ToString()%>', 
        minDate: new Date(),
        maxDate: '3m',
...
$('#id_fecha_salida').datetimepicker({
dayOfWeekStart : 1,
lang:'es',
	formatDate:'Y-m-d',
	minTime:'8:00',
